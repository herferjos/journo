...
if 'email' in st.session_state and st.session_state.user_subscribed == True:
    ...
    if 'noticia_generada' in st.session_state and 'inicio' in st.session_state:
        ...
        if chosen_id == "5":
            ...
            st.session_state.noticia_generada = st.text_area(label = ":blue[Noticia generada]", value = st.session_state.noticia_generada, height = int(len(st.session_state.noticia_generada)/4))
